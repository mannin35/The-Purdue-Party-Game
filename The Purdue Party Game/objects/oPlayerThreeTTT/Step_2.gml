...
if(direct_path && global.localPlayers[2].isCPU && walksp>0) {	
	//direct route to finish line	
	myPath = path_add();
	if(mp_grid_path(global.maze_grid, myPath, x, y,player_three_finish_TTT.x, player_three_finish_TTT.y, true)){
