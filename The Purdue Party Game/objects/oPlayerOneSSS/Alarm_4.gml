...
tempX = oPlayerOneSSS.x;
tempY = oPlayerOneSSS.y;
if (!hit && !player_two_SSS.hit && grabbedWho == 2) { // P1 > P2
	...
	oPlayerOneSSS.x = player_two_SSS.x;
	oPlayerOneSSS.y = player_two_SSS.y;
	...
	oPlayerOneSSS.x = player_three_SSS.x;
	oPlayerOneSSS.y = player_three_SSS.y;
	...
	oPlayerOneSSS.x = player_four_SSS.x;
	oPlayerOneSSS.y = player_four_SSS.y;
