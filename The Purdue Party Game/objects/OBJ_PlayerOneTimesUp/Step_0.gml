...
left = 0;
right = 0;
if(!global.playerOneTU && !global.playerObjects[0].isCPU){
	left = gamepad_axis_value(global.playercontrollerindices[0], gp_axislh) < -.2;
	right = gamepad_axis_value(global.playercontrollerindices[0], gp_axislh) > .2;
}
