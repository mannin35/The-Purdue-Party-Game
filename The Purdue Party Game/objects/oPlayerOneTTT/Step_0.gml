...
if !(over) {
	if (TTT_Controller.cn_swap = 0) {
		...
		left_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislv) > dead_zone);
		right_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislh) < -dead_zone);
		up_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislh) > dead_zone); 
		down_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislv) < -dead_zone);
	} else if (TTT_Controller.cn_swap = 2) {
		left_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislv) < -dead_zone);
		right_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislv) > dead_zone);
		up_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislh) < -dead_zone);
		down_input = (gamepad_axis_value(global.playercontrollerindices[0], gp_axislh) > dead_zone); 
