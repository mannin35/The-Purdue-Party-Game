...
Welcome to The Purdue Party Game!

This local multiplayer party game offers an exciting and immersive gaming experience based on the history, locations, and culture of Purdue University. It features a main game board with shops, trivia, and bus spaces. Each player makes their way around the board attempting to collect the most Degrees, which will spawn randomly on Degree spaces. After each player completes their turn, a minigame will be randomly selected in which all players will compete to earn Boiler  Bucks. Both main map gameplay and minigames support 0-4 human players, with the remaining player spots taken up by CPU players, whose difficulty can be changed in the game set-up menu.
...
People need an outlet for fun with their friends. 
Video games like the one we’re making are an immersive and interactive solution. 
...
Build a video game that consists of multiple small puzzle/party games and supports local multiplayer
Implement controller support
Design memorable sprites with a wide range of animations
Design gameplay akin to a party game: a main ‘game-board’ with different types of minigames, a luck-based factor, and a competition factor
...
PUrdue University CS307 Team 3:
Scrum Master: Daniel Spear
Team Members: Ellison Hohmann, Jack Slater, Rei Manning, & Ryan Parris

Project Coordinator: Dawon Jeong
Project Grader: Ming Ti
